...
<div id="content" class="table-content">
	<?php $this->layout->load_view('clients/widgets'); ?>
    ...
    <div id="filter_results">
		...
		<a class="client_add_btn btn btn-primary btn-sm" href="<?php echo site_url('clients/form'); ?>">
            <i class="fa fa-user"></i> <?php _trans('add_client'); ?>
        </a>
