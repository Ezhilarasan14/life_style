<header class="main-header">
    ...
    <a href="<?php echo site_url('dashboard'); ?>" class="logo">
      ...
      <span class="logo-mini"><b>E</b>ON</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Ka</b>ppa</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo($this->session->userdata('user_name')); ?> - <?php if($this->session->userdata('user_type')==1){ echo "Administrator"; } else if($this->session->userdata('user_type')==2){ echo "Guest"; }  ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('users/form/' .$this->session->userdata('user_id')); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo site_url('sessions/logout'); ?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
